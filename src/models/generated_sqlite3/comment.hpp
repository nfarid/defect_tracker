...
public:
    ...
    const uint64_t& getValueOfTicketId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint64_t>& getTicketId() const noexcept;
    ///Set the value of the column ticket_id
    void setTicketId(const uint64_t& pTicketId) noexcept;

    /**  For column poster_id  */
    ///Get the value of the column poster_id, returns the default value if the column is null
    const uint64_t& getValueOfPosterId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint64_t>& getPosterId() const noexcept;
    ///Set the value of the column poster_id
    void setPosterId(const uint64_t& pPosterId) noexcept;
...
private:
    ...
    std::shared_ptr<uint64_t> ticketId_;
    std::shared_ptr<uint64_t> posterId_;
    struct MetaData{
