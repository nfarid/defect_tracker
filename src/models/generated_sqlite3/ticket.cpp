...
const std::vector<typename Ticket::MetaData> Ticket::metaData_={
    ...
    {"severity", "std::string", "text", 0, 0, 0, 1},
    {"created_date", "std::string", "timestamp", 0, 0, 0, 1},
    {"resolved_date", "std::string", "timestamp", 0, 0, 0, 0},
    {"image_filename", "std::string", "text", 0, 0, 0, 0},
    {"reporter_id", "uint64_t", "integer", 8, 0, 0, 1},
    {"assigned_id", "uint64_t", "integer", 8, 0, 0, 0},
...
Ticket::Ticket(const Row& r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0) {
        ...
        if(!r["reporter_id"].isNull() )
            reporterId_=std::make_shared<uint64_t>(r["reporter_id"].as<uint64_t>() );
        if(!r["assigned_id"].isNull() )
            assignedId_=std::make_shared<uint64_t>(r["assigned_id"].as<uint64_t>() );
        ...
        index = offset + 8;
        if(!r[index].isNull() )
            reporterId_=std::make_shared<uint64_t>(r[index].as<uint64_t>() );
        index = offset + 9;
        if(!r[index].isNull() )
            assignedId_=std::make_shared<uint64_t>(r[index].as<uint64_t>() );
        index = offset + 10;
        if(!r[index].isNull() )
...
Ticket::Ticket(const Json::Value& pJson, const std::vector<std::string>& pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[8].empty() && pJson.isMember(pMasqueradingVector[8]) ) {
        ...
        if(!pJson[pMasqueradingVector[8]].isNull() )
            reporterId_=std::make_shared<uint64_t>( (uint64_t)pJson[pMasqueradingVector[8]].asUInt64() );
    }
    if(!pMasqueradingVector[9].empty() && pJson.isMember(pMasqueradingVector[9]) ) {
        dirtyFlag_[9] = true;
        if(!pJson[pMasqueradingVector[9]].isNull() )
            assignedId_=std::make_shared<uint64_t>( (uint64_t)pJson[pMasqueradingVector[9]].asUInt64() );
    }
    if(!pMasqueradingVector[10].empty() && pJson.isMember(pMasqueradingVector[10]) ) {
        dirtyFlag_[10] = true;
        if(!pJson[pMasqueradingVector[10]].isNull() )
            projectId_=std::make_shared<uint64_t>( (uint64_t)pJson[pMasqueradingVector[10]].asUInt64() );
    }
}
...
Ticket::Ticket(const Json::Value& pJson) noexcept(false)
{
    ...
    if(pJson.isMember("reporter_id") ) {
        ...
        if(!pJson["reporter_id"].isNull() )
            reporterId_=std::make_shared<uint64_t>( (uint64_t)pJson["reporter_id"].asUInt64() );
    }
    if(pJson.isMember("assigned_id") ) {
        dirtyFlag_[9]=true;
        if(!pJson["assigned_id"].isNull() )
            assignedId_=std::make_shared<uint64_t>( (uint64_t)pJson["assigned_id"].asUInt64() );
    }
...
const uint64_t& Ticket::getValueOfId() const noexcept
{
...
const std::shared_ptr<uint64_t>& Ticket::getId() const noexcept
{
    return id_;
}

void Ticket::setId(const uint64_t& pId) noexcept
{
    id_ = std::make_shared<uint64_t>(pId);
    dirtyFlag_[0] = true;
}

void Ticket::setIdToNull() noexcept
{
    id_.reset();
    dirtyFlag_[0] = true;
}
...
const uint64_t& Ticket::getValueOfReporterId() const noexcept
{
    const static uint64_t defaultValue = uint64_t();
    if(reporterId_)
        return *reporterId_;
...
const std::shared_ptr<uint64_t>& Ticket::getReporterId() const noexcept
{
    return reporterId_;
}

void Ticket::setReporterId(const uint64_t& pReporterId) noexcept
{
    reporterId_ = std::make_shared<uint64_t>(pReporterId);
    dirtyFlag_[8] = true;
}

const uint64_t& Ticket::getValueOfAssignedId() const noexcept
{
    const static uint64_t defaultValue = uint64_t();
    if(assignedId_)
        return *assignedId_;
...
const std::shared_ptr<uint64_t>& Ticket::getAssignedId() const noexcept
{
    return assignedId_;
}

void Ticket::setAssignedId(const uint64_t& pAssignedId) noexcept
{
    assignedId_ = std::make_shared<uint64_t>(pAssignedId);
    dirtyFlag_[9] = true;
}
...
const uint64_t& Ticket::getValueOfProjectId() const noexcept
{
    const static uint64_t defaultValue = uint64_t();
    if(projectId_)
        return *projectId_;
...
const std::shared_ptr<uint64_t>& Ticket::getProjectId() const noexcept
{
    return projectId_;
}

void Ticket::setProjectId(const uint64_t& pProjectId) noexcept
{
...
Json::Value Ticket::toJson() const
{
    ...
    if(getReporterId() )
        ret["reporter_id"]=(Json::UInt64)getValueOfReporterId();
    else
        ret["reporter_id"]=Json::Value();
    if(getAssignedId() )
        ret["assigned_id"]=(Json::UInt64)getValueOfAssignedId();
    else
    ...
    const std::vector<std::string>& pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 11) {
        ...
        if(!pMasqueradingVector[8].empty() ) {
            if(getReporterId() )
                ret[pMasqueradingVector[8]]=(Json::UInt64)getValueOfReporterId();
            else
                ret[pMasqueradingVector[8]]=Json::Value();
        }
        if(!pMasqueradingVector[9].empty() ) {
            if(getAssignedId() )
                ret[pMasqueradingVector[9]]=(Json::UInt64)getValueOfAssignedId();
            else
                ret[pMasqueradingVector[9]]=Json::Value();
        }
        if(!pMasqueradingVector[10].empty() ) {
            if(getProjectId() )
                ret[pMasqueradingVector[10]]=(Json::UInt64)getValueOfProjectId();
            else
...
{
    const static std::string sql = "select * from project where id = ?";
    *clientPtr << sql
               << *projectId_
...
void Ticket::getComments(const DbClientPtr& clientPtr,
        ...
        const ExceptionCallback& ecb) const
{
    const static std::string sql = "select * from comment where poster_id = ?";
    *clientPtr << sql
               << *id_
