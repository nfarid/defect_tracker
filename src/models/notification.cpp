...
const std::vector<typename Notification::MetaData> Notification::metaData_={
    ...
    {"summary", "std::string", "text", 0, false, false, true},
    {"user_id", "int32_t", "integer", 4, false, false, true},
        ...
        std::vector<std::string>& pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[2].empty() && pJson.isMember(pMasqueradingVector[2]) ) {
        ...
        if(!pJson[pMasqueradingVector[2]].isNull() )
            userId_=std::make_shared<int32_t>( static_cast<int32_t>(pJson[pMasqueradingVector[2]].asInt64() ) );
    }
...
Notification::Notification(const Json::Value& pJson) noexcept(false)
{
    ...
    if(pJson.isMember("user_id") ) {
        ...
        if(!pJson["user_id"].isNull() )
            userId_=std::make_shared<int32_t>( static_cast<int32_t>(pJson["user_id"].asInt64() ) );
    }
