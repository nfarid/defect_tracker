...
Staff::Staff(const Json::Value& pJson, const std::vector<std::string>& pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[1].empty() && pJson.isMember(pMasqueradingVector[1]) ) {
        ...
        if(!pJson[pMasqueradingVector[1]].isNull() )
            projectId_=std::make_shared<int32_t>( static_cast<int32_t>(pJson[pMasqueradingVector[1]].asInt64() ) );
    }
    if(!pMasqueradingVector[2].empty() && pJson.isMember(pMasqueradingVector[2]) ) {
        dirtyFlag_[2] = true;
        if(!pJson[pMasqueradingVector[2]].isNull() )
            staffId_=std::make_shared<int32_t>( static_cast<int32_t>(pJson[pMasqueradingVector[2]].asInt64() ) );
    }
}
...
Staff::Staff(const Json::Value& pJson) noexcept(false)
{
    ...
    if(pJson.isMember("staff_id") ) {
        ...
        if(!pJson["staff_id"].isNull() )
            staffId_=std::make_shared<int32_t>( static_cast<int32_t>(pJson["staff_id"].asInt64() ) );
    }
}
